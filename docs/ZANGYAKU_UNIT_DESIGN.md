...
| Rifle | Neatly parted black hair; clean-shaven; normal black sunglasses | Tucked white V-neck; sleek gray trousers; polished black dress shoes; fitted black gloves |
...
Latest correction: owner rejected circular rifle glasses. Replaced with conventional black sunglasses with dark lenses. Standing/aiming render visually checked; full 1,080-frame geometry/bounds review passed. Local revision only; push remains blocked.
