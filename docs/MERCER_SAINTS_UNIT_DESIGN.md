...
- Preserve the established body proportions exactly. Suggest loose fabric with
  restrained wrinkles, or omit bagginess; never resize the torso or other anatomy.
- Shoulders and sleeves form a continuous garment, with no heavy black line
  separating an arm from the torso.
- Follow `UNIT_ART_STANDARD.md`: explicitly inspect the standing left shoulder
  and weapon/body consistency across the produced stances and angles.
