...
static func _raw_is_useful_protection_factor(protection_factor: float) -> bool:
...
static func _raw_relevant_cover_threat(
...
static func _raw_rank_legal_slots_on_cover_object(
	battle_state: BattleState,
	participant: BattleParticipant,
...
static func _raw_occupied_cover_is_suitable(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant,
...
static func _raw_occupied_cover_still_protects(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant
) -> bool:
...
static func _raw_select_best_combat_usable_slot(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant,
...
static func _raw_rank_combat_usable_within_radius(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant,
	require_weapon_range: bool,
...
static func _raw_rank_combat_usable(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant,
	require_weapon_range: bool,
...
static func _raw_rank_healthy_role(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant,
...
static func _raw_rank_closing_cover(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant,
	weapon_type_id: String,
...
static func _raw_rank_short_range_in_useful_range(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant,
	max_move_distance: float
...
static func _raw_rank_short_range_nearby_useful(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant,
	require_weapon_range: bool,
...
static func _raw_rank_short_range_out_of_range_staging(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile: BattleParticipant,
	weapon_type_id: String,
...
static func _raw_evaluate_slot(
	battle_state: BattleState,
	participant: BattleParticipant,
...
static func _raw_first_reachable_ranked_slot(
	battle_state: BattleState,
	participant: BattleParticipant,
...
static func _raw__insert_ranked(
	ranked: Array[BattleCombatCoverEvaluation],
...
static func _raw__insert_closing_ranked(
	ranked: Array[BattleCombatCoverEvaluation],
	candidate: BattleCombatCoverEvaluation
) -> void:
	var index: int = 0
...
static func _raw__insert_near_first_ranked(
	ranked: Array[BattleCombatCoverEvaluation],
	candidate: BattleCombatCoverEvaluation
) -> void:
	var index: int = 0
...
static func _raw__insert_staging_ranked(
	ranked: Array[BattleCombatCoverEvaluation],
	candidate: BattleCombatCoverEvaluation
) -> void:
	var index: int = 0
...
static func _raw__closing_rank_less(left: BattleCombatCoverEvaluation, right: BattleCombatCoverEvaluation) -> bool:
	if not is_equal_approx(left.protection_factor, right.protection_factor):
		return left.protection_factor > right.protection_factor
...
static func _raw__near_first_rank_less(
	left: BattleCombatCoverEvaluation,
	right: BattleCombatCoverEvaluation
) -> bool:
	if not is_equal_approx(left.move_distance, right.move_distance):
...
static func _raw__staging_rank_less(
	left: BattleCombatCoverEvaluation,
	right: BattleCombatCoverEvaluation
) -> bool:
	if not is_equal_approx(left.move_distance, right.move_distance):
...
static func _raw__insert_object_cover_ranked(
	ranked: Array[BattleCombatCoverEvaluation],
	candidate: BattleCombatCoverEvaluation,
	has_threat: bool
) -> void:
...
static func _raw__object_cover_rank_less(
	left: BattleCombatCoverEvaluation,
	right: BattleCombatCoverEvaluation,
	has_threat: bool
) -> bool:
...
static func _raw__living_hostile_by_id(
	battle_state: BattleState,
	participant: BattleParticipant,
	hostile_id: String
) -> BattleParticipant:
...
static func _raw__nearest_living_hostile(
	battle_state: BattleState,
	participant: BattleParticipant
) -> BattleParticipant:
...
static func _raw__slot_is_legal_for_participant(participant: BattleParticipant, slot: BattleCoverSlot) -> bool:
	if participant == null or slot == null or not slot.is_valid():
		return false
...
static func _raw__slot_is_reachable(
	battle_state: BattleState,
	participant: BattleParticipant,
	slot: BattleCoverSlot
) -> bool:
...
static func _raw__slot_is_within_weapon_max_range(
	slot: BattleCoverSlot,
	hostile: BattleParticipant,
	weapon_type_id: String
) -> bool:
...
static func is_useful_protection_factor(protection_factor: float) -> bool:
	...
	var result = _raw_is_useful_protection_factor(protection_factor)
	Probe.record('cover_eval.is_useful_protection_factor', Time.get_ticks_usec()-t)
	return result
...
static func relevant_cover_threat(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_relevant_cover_threat(battle_state, participant)
	Probe.record('cover_eval.relevant_cover_threat', Time.get_ticks_usec()-t)
	return result
...
static func rank_legal_slots_on_cover_object(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_rank_legal_slots_on_cover_object(battle_state, participant, cover_object_id, hostile)
	Probe.record('cover_eval.rank_legal_slots_on_cover_object', Time.get_ticks_usec()-t)
	return result
...
static func occupied_cover_is_suitable(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_occupied_cover_is_suitable(battle_state, participant, hostile, require_weapon_range)
	Probe.record('cover_eval.occupied_cover_is_suitable', Time.get_ticks_usec()-t)
	return result
...
static func occupied_cover_still_protects(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_occupied_cover_still_protects(battle_state, participant, hostile)
	Probe.record('cover_eval.occupied_cover_still_protects', Time.get_ticks_usec()-t)
	return result
...
static func select_best_combat_usable_slot(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_select_best_combat_usable_slot(battle_state, participant, hostile, require_weapon_range, max_move_distance)
	Probe.record('cover_eval.select_best_combat_usable_slot', Time.get_ticks_usec()-t)
	return result
...
static func rank_combat_usable_within_radius(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_rank_combat_usable_within_radius(battle_state, participant, hostile, require_weapon_range, origin, radius)
	Probe.record('cover_eval.rank_combat_usable_within_radius', Time.get_ticks_usec()-t)
	return result
...
static func rank_combat_usable(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_rank_combat_usable(battle_state, participant, hostile, require_weapon_range, max_move_distance)
	Probe.record('cover_eval.rank_combat_usable', Time.get_ticks_usec()-t)
	return result
...
static func rank_healthy_role(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_rank_healthy_role(battle_state, participant, hostile, weapon_type_id, require_weapon_range, max_move_distance)
	Probe.record('cover_eval.rank_healthy_role', Time.get_ticks_usec()-t)
	return result
...
static func rank_closing_cover(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_rank_closing_cover(battle_state, participant, hostile, weapon_type_id, max_move_distance)
	Probe.record('cover_eval.rank_closing_cover', Time.get_ticks_usec()-t)
	return result
...
static func rank_short_range_in_useful_range(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_rank_short_range_in_useful_range(battle_state, participant, hostile, max_move_distance)
	Probe.record('cover_eval.rank_short_range_in_useful_range', Time.get_ticks_usec()-t)
	return result
...
static func rank_short_range_nearby_useful(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_rank_short_range_nearby_useful(battle_state, participant, hostile, require_weapon_range, max_move_distance)
	Probe.record('cover_eval.rank_short_range_nearby_useful', Time.get_ticks_usec()-t)
	return result
...
static func rank_short_range_out_of_range_staging(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_rank_short_range_out_of_range_staging(battle_state, participant, hostile, weapon_type_id, max_move_distance)
	Probe.record('cover_eval.rank_short_range_out_of_range_staging', Time.get_ticks_usec()-t)
	return result
...
static func evaluate_all(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_evaluate_all(battle_state, participant, hostile, require_reachable, require_weapon_range, max_move_distance)
	Probe.record('cover_eval.evaluate_all', Time.get_ticks_usec()-t)
	return result
...
static func evaluate_slot(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_evaluate_slot(battle_state, participant, slot, hostile, require_reachable, require_weapon_range, max_move_distance)
	Probe.record('cover_eval.evaluate_slot', Time.get_ticks_usec()-t)
	return result
...
static func first_reachable_ranked_slot(
	...
	var t := Time.get_ticks_usec()
	var result = _raw_first_reachable_ranked_slot(battle_state, participant, ranked, skip_self_occupied)
	Probe.record('cover_eval.first_reachable_ranked_slot', Time.get_ticks_usec()-t)
	return result
...
static func _insert_ranked(
	...
	var t := Time.get_ticks_usec()
	_raw__insert_ranked(ranked, candidate, prefer_band)
	Probe.record('cover_eval._insert_ranked', Time.get_ticks_usec()-t)
...
static func _insert_closing_ranked(
	...
	var t := Time.get_ticks_usec()
	_raw__insert_closing_ranked(ranked, candidate)
	Probe.record('cover_eval._insert_closing_ranked', Time.get_ticks_usec()-t)
...
static func _insert_near_first_ranked(
	...
	var t := Time.get_ticks_usec()
	_raw__insert_near_first_ranked(ranked, candidate)
	Probe.record('cover_eval._insert_near_first_ranked', Time.get_ticks_usec()-t)
...
static func _insert_staging_ranked(
	...
	var t := Time.get_ticks_usec()
	_raw__insert_staging_ranked(ranked, candidate)
	Probe.record('cover_eval._insert_staging_ranked', Time.get_ticks_usec()-t)
...
static func _rank_less(
	...
	var t := Time.get_ticks_usec()
	var result = _raw__rank_less(left, right, prefer_band)
	Probe.record('cover_eval._rank_less', Time.get_ticks_usec()-t)
	return result


static func _closing_rank_less(left: BattleCombatCoverEvaluation, right: BattleCombatCoverEvaluation) -> bool:
	var t := Time.get_ticks_usec()
	var result = _raw__closing_rank_less(left, right)
	Probe.record('cover_eval._closing_rank_less', Time.get_ticks_usec()-t)
	return result
...
static func _near_first_rank_less(
	...
	var t := Time.get_ticks_usec()
	var result = _raw__near_first_rank_less(left, right)
	Probe.record('cover_eval._near_first_rank_less', Time.get_ticks_usec()-t)
	return result
...
static func _staging_rank_less(
	...
	var t := Time.get_ticks_usec()
	var result = _raw__staging_rank_less(left, right)
	Probe.record('cover_eval._staging_rank_less', Time.get_ticks_usec()-t)
	return result
...
static func _insert_object_cover_ranked(
	...
	var t := Time.get_ticks_usec()
	_raw__insert_object_cover_ranked(ranked, candidate, has_threat)
	Probe.record('cover_eval._insert_object_cover_ranked', Time.get_ticks_usec()-t)
...
static func _object_cover_rank_less(
	...
	var t := Time.get_ticks_usec()
	var result = _raw__object_cover_rank_less(left, right, has_threat)
	Probe.record('cover_eval._object_cover_rank_less', Time.get_ticks_usec()-t)
	return result
...
static func _living_hostile_by_id(
	...
	var t := Time.get_ticks_usec()
	var result = _raw__living_hostile_by_id(battle_state, participant, hostile_id)
	Probe.record('cover_eval._living_hostile_by_id', Time.get_ticks_usec()-t)
	return result
...
static func _nearest_living_hostile(
	...
	var t := Time.get_ticks_usec()
	var result = _raw__nearest_living_hostile(battle_state, participant)
	Probe.record('cover_eval._nearest_living_hostile', Time.get_ticks_usec()-t)
	return result


static func _slot_is_legal_for_participant(participant: BattleParticipant, slot: BattleCoverSlot) -> bool:
	var t := Time.get_ticks_usec()
	var result = _raw__slot_is_legal_for_participant(participant, slot)
	Probe.record('cover_eval._slot_is_legal_for_participant', Time.get_ticks_usec()-t)
	return result
...
static func _slot_is_reachable(
	...
	var t := Time.get_ticks_usec()
	var result = _raw__slot_is_reachable(battle_state, participant, slot)
	Probe.record('cover_eval._slot_is_reachable', Time.get_ticks_usec()-t)
	return result
...
static func _slot_is_within_weapon_max_range(
	...
	var t := Time.get_ticks_usec()
	var result = _raw__slot_is_within_weapon_max_range(slot, hostile, weapon_type_id)
	Probe.record('cover_eval._slot_is_within_weapon_max_range', Time.get_ticks_usec()-t)
	return result
...
static func _participant_weapon_type_id(participant: BattleParticipant) -> String:
	...
	Probe.record('cover_eval._participant_weapon_type_id', Time.get_ticks_usec()-t)
	return result
...
static func _is_positioned(participant: BattleParticipant) -> bool:
	...
	Probe.record('cover_eval._is_positioned', Time.get_ticks_usec()-t)
	return result
