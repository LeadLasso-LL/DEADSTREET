...
func run():
 ...
 for spec in [[5,5,["bayou","bayou"],["interceptor","warden"]],[12,12,["lastlight"],["bulwark","warden"]],[1,1,["yardbird"],["yardbird"]],[12,12,["yardbird","yardbird","yardbird","yardbird","yardbird","yardbird","yardbird","yardbird","yardbird","yardbird","yardbird","yardbird"],["bayou","bayou","bayou"]]]:
  ...
  r.free()
 DirAccess.make_dir_recursive_absolute("res://tools/bridge_map/revision_results")
 FileAccess.open("res://tools/bridge_map/revision_results/validation.json",FileAccess.WRITE).store_string(JSON.stringify({"checks":checks,"errors":errors,"scenarios":scenarios},"  "))
