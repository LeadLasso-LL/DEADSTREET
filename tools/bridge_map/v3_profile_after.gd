...
func run():
 ...
 FileAccess.open("res://tools/bridge_map/v3_results/profile_after.json",FileAccess.WRITE).store_string(JSON.stringify(report,"  "));print("BRIDGE_PROFILE ",report);quit()
