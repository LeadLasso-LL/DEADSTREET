...
motion=json.loads((o/'motion_comparison.json').read_text());assert motion['after']['first20_camera_changes']==0 and motion['after']['body_offset_max']==0
...
args=[godot,'--path',str(o/'capture_project'),'--resolution','1920x1080','--position','0,0','--fixed-fps','30','--disable-vsync','--write-movie',str(frames/'frame.png'),'--log-file',str(o/'capture_godot.log'),'--script','res://tools/freight_stability_20260915/showcase.gd','--','--record']
...
full_motion=json.loads((o/'full_motion.json').read_text());assert full_motion['unexpected_camera_changes']==0 and full_motion['body_offset_errors']==0,full_motion
...
final=o/'DEAD_STREET_Eastex_Freight_Exchange_Stable.mp4'
