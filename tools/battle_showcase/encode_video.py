...
src=R/'harold_4v4_raw.avi';out=R/'Dead_Street_Harold_Audio_Cinematics.mp4'
...
for label,t in [('opening',.6),('arrival',5.7),('deployment',9),('combat',16),('middle',length*.55),('results',length-4)]:
