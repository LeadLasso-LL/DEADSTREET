...
def extend(groups):
 ...
 groups['passenger_cars'].append(('nocturne','Nocturne RS','driveby_sedan',4,7.1,1150000,1650,0,5.12,2.02,1.32,'181d20','Gloss-black performance sedan with a low pillarless-style cabin, bronze wheels and sculpted carbon side skirts.'))
def apply(models):
 for id in IDS:
 ...
 models['nocturne'].update(doors=4,door_rows=[.20,-.22],roof_color='#202629')
