...
'two_wheelers':[
 ...
 ('switchblade','Switchblade 600','streetbike',1,6.8,5700,14,0,2.05,.76,1.15,'383f46','Stripped streetfighter with a solo seat and exposed engine.'),
 ('nightjar','Nightjar RR','sportbike',2,7.5,13500,28,0,2.1,.76,1.12,'8e3e37','Fully faired sports motorcycle; quickest road option, little protection.'),
 ...
 ('longhaul','Longhaul Tourer','tourer',2,5.2,17800,32,0,2.65,1.05,1.35,'584338','Heavy touring motorcycle with windshield and small personal panniers.')],
'passenger_cars':[
 ...
 ('monarch','Monarch V12','luxury',4,6.,78000,115,0,5.5,2.02,1.57,'171d23','Formal luxury saloon with a tall grille and substantial rear seating.'),
 ('regent','Regent Town Car','towncar',4,5.2,46000,78,0,5.55,2.02,1.53,'242825','Traditional chauffeur-style sedan, formal roofline and chrome grille.'),
 ('volta','Volta GT','grandtourer',2,6.9,68000,98,0,4.65,1.94,1.28,'9c9e93','Low, long-hood grand tourer with two usable seats.'),
 ('specter','Specter S','sportcoupe',2,7.2,95000,125,0,4.48,1.96,1.2,'d2c7ae','Mid-engine sports coupe: fastest car, high cost and two seats.'),
...
'utility_vehicles':[
 ...
 ('sentinel','Sentinel Luxe','luxury_suv',7,5.1,86000,125,0,5.5,2.13,1.98,'252c32','Polished three-row luxury SUV with dark glass and bright grille.'),
 ...
 ('watchdog','Watchdog Tactical','tactical_utility',5,4.5,92000,150,0,5.05,2.14,1.98,'536747','TRC enclosed tactical utility truck; no turret or mounted gun.'),
...
PREFERENCES={
 ...
 'ravicci':['monarch','volta','regent','sentinel','meridian','harbor'],
 ...
 'sierra_roja':['nightjar','cabrillo','sentinel','backcountry','mesa','meridian'],
 ...
 'trc':['switchblade','blackwater','watchdog','rancher','meridian','bastion'],
 'nbpd':['interceptor','warden','longhaul','crossway','shuttle','meridian'],
