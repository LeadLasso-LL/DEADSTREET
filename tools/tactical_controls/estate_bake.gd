...
func run():
 ...
 var art=load("res://gameplay/whittaker_estate_art.gd").new();art.bake_mode=true;art.position=Vector2(512,384);vp.add_child(art)
 ...
 print("ESTATE_GROUND_BAKED ",result," 3072x1536");quit(result)
