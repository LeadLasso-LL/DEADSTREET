...
- `native.json`: 39 checks, zero errors. Production arsenal scene, 24 rendered
...
- `hud_paused_full_force.png`, `hud_orders.png`: actual native HUD captures.
...
Native five-second commanded smoke: 59.91 FPS. This is a responsiveness check,
...
Source scope: the working repository contained unrelated participant/view hunks
