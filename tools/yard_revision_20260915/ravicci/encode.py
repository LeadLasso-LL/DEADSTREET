...
r=Path(r'C:\Users\brand\OneDrive\Documents\dead-street');o=r/'tools/yard_revision_20260915/ravicci';ff=imageio_ffmpeg.get_ffmpeg_exe()
...
final=o/'DEAD_STREET_Ravicci_Raid_Doble_Ocho.mp4'
