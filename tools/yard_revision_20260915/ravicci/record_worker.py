...
args=[r'C:\Users\brand\OneDrive\Documents\Godot\Godot_v4.7.2-stable_win64.exe','--path',str(r),'--resolution','1280x720','--position','0,0','--fixed-fps','30','--disable-vsync','--write-movie',str(raw),'--log-file',str(o/'capture_godot.log'),'--script','res://tools/yard_revision_20260915/ravicci/showcase.gd','--','--record']
