...
r=Path(r'C:\Users\brand\OneDrive\Documents\dead-street');o=r/'tools/fourth_map_20260915';ff=imageio_ffmpeg.get_ffmpeg_exe()
...
raw=o/'yard_raw_v2.avi';trim=record['trim_frames']/30
...
final=o/'DEAD_STREET_Doble_Ocho_Battle.mp4'
