...
args=[r'C:\Users\brand\OneDrive\Documents\Godot\Godot_v4.7.2-stable_win64.exe','--path',str(r),'--resolution','1440x900','--position','0,0','--log-file',str(o/(mode+'_godot.log')),'--script','res://tools/yard_revision_20260915/'+script]
