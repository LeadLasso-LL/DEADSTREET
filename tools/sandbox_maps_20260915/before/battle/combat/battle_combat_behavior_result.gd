...
var healthy_cover_searches: int = 0
var wounded_cover_searches: int = 0
var defend_sample_searches: int = 0
var combat_path_searches: int = 0
...
static func succeeded(
	...
	result.hits = p_hits
	result.wounded = p_wounded
	result.killed = p_killed
	result.wounds = p_wounded
	result.kills = p_killed
