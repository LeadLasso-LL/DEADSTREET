...
def main():
    ...
    p.add_argument('faction',choices=['eastex','whittaker','calle_ocho','ventresca','ravicci','zangyaku','bitian','stateline','sierra_roja','mcallister','trc','nbpd','mercer44','wm_corp','union_sur','lombardia','sand_raiders'])
