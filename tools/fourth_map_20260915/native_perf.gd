...
func run():
 ...
 FileAccess.open("res://tools/fourth_map_20260915/native_perf.json",FileAccess.WRITE).store_string(JSON.stringify(report,"\t"));print("NATIVE_PERF ",JSON.stringify(report));quit()
