...
var elapsed_after=0.
var seed_value=2011
var out="res://tools/battle_polish/results"
var seen={}
var events=[]
var transitions=[]
var last_states={}
...
func _process(_delta: float) -> bool:
 ...
 for i in range(12 if fast else 1):
  ...
  if time>=180. or elapsed_after>=9.:
   if hold:
