...
def card(r):
    ...
    d.text((65,94),'FACTION AUDIO  /  DARK REBUILD 02',font=f(17),fill=(143,146,140))
...
meta=[';FFMETADATA1','title=DEAD STREET — Dark Rebuild 02 — All 18','artist=DEAD STREET','comment=New dark compositions after rejected audition01. Tempos 20 percent lower. Preview only; pending owner approval.']
t=0
for r in rows:
...
video=OUT/'Dead_Street_Dark_Rebuild_02_All_18.mp4'
...
(OUT/'Dead_Street_Dark_Rebuild_02_Player.html').write_text(page)
...
lines=['# DEAD STREET — all 18 faction auditions','', 'Instrumental sketches for listening review. No runtime integration; no approved soundtrack assets.','', '| # | Faction | Reel start | Vibe |','|---|---|---|---|']
for r in rows:
