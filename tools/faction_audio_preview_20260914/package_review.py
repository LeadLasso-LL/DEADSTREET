...
def card(r):
    num=r['number']; accent=(201,172,119)
    ...
    d.text((65,94),'FACTION AUDIO  /  AUDITION 01',font=f(17),fill=(143,146,140))
...
meta=[';FFMETADATA1','title=DEAD STREET — All 18 Faction Audio Previews','artist=DEAD STREET','comment=Original instrumental audition sketches. Pending owner review; not installed in game.']
t=0
for r in rows:
...
video=OUT/'Dead_Street_All_18_Faction_Audio_Previews.mp4'
...
(OUT/'Dead_Street_Faction_Audio_Player.html').write_text(page)
