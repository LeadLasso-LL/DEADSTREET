...
func yard_ground():
 ...
 for box in [Rect2(-192,45.7,192,5.3),Rect2(20,45.7,300,5.3),Rect2(-192,68,512,5),Rect2(-5,-160,5,211),Rect2(20,-160,6,205.7)]:
  ground_rect(box,Color("#7b7661"),1800)
 for x in range(-190,320,4):
  if x<0 or x>20:ground_line(Vector2(x,46),Vector2(x,50.8),Color("#595e4f"),.65)
  ground_line(Vector2(x,68.3),Vector2(x,72.8),Color("#585c4c"),.65)
 for y in range(-158,46,4):
  ground_line(Vector2(-4.8,y),Vector2(-.2,y),Color("#565d4c"),.65)
  if y<26 or y>40:ground_line(Vector2(20.2,y),Vector2(25.8,y),Color("#565d4c"),.65)
 for pair in [[Vector2(-192,50.8),Vector2(0,50.8)],[Vector2(20,50.8),Vector2(88,50.8)],[Vector2(102,50.8),Vector2(320,50.8)],[Vector2(-192,68.2),Vector2(320,68.2)],[Vector2(.1,-160),Vector2(.1,51)],[Vector2(20,-160),Vector2(20,26)],[Vector2(20,40),Vector2(20,50.8)]]:
  ...
  ground_line(a,b,Color("#a39778"),2.);ground_line(a+Vector2(0,.35),b+Vector2(0,.35),Color("#444d42"),.8)
 ...
 ground_rect(Rect2(20,26,12.5,14),Color("#73715c"),620)
 ground_rect(Rect2(88,42,14,9),Color("#75715b"),700)
 ground_line(Vector2(20,26),Vector2(20,40),Color("#969174"),1.)
 ground_line(Vector2(88,50.8),Vector2(102,50.8),Color("#969174"),1.)
