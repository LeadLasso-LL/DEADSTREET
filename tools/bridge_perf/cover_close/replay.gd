...
func run():
 ...
 FileAccess.open("C:/Users/brand/OneDrive/Documents/dead-street/tools/bridge_perf/cover_close/replay.json",FileAccess.WRITE).store_string(JSON.stringify(report,"  "))
