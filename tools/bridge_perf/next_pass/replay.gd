...
const OldRuntime=preload("res://tools/bridge_perf/next_pass/oracle_runtime.gd")
...
func run():
 ...
 FileAccess.open("res://tools/bridge_perf/next_pass/replay.json",FileAccess.WRITE).store_string(JSON.stringify(report,"  "))
