param([string]$Godot, [int]$Seed = 2011)
...
'@ | Set-Content -Encoding ASCII override.cfg
    ...
    & $Godot --path . --borderless --position 0,0 --resolution 1920x1080 --fixed-fps 30 --disable-vsync --write-movie tools/battle_finish/results/harold_4v4_raw.avi --script tools/battle_finish/review.gd -- "--seed=$Seed" --recording
