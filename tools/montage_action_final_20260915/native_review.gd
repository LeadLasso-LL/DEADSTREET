...
func run():
 ...
 stream.file="res://tools/montage_action_final_20260915/montage_candidate.ogv"
 ...
 FileAccess.open("res://tools/montage_action_final_20260915/native_validation.json",FileAccess.WRITE).store_string(JSON.stringify(report,"  "))
