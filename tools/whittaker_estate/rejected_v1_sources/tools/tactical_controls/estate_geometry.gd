...
func run():
 ...
 for route in [["main gate",Vector2(43.5,65),Vector2(68,65)],["north garden",Vector2(37,28),Vector2(73,28)],["south service",Vector2(37,91),Vector2(70,91)],["front steps",Vector2(95,78),Vector2(151,68)]]:
  var path=Nav.find_path(b,route[1],route[2])
  checks.append({"route":route[0],"reachable":path!=null and path.success})
